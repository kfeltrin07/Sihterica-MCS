...
export class PdfOvlasteneOsobeMjTrComponent {
  ...
  public generatePDF(columns: string[], data: any, numberOfColumns: number, title: string): void {
    ...
    this.globalVar.headerTitle = this.t.translate('OvlasteneOsobeMjTr');
  ...
  public getData(): void {
    ...
    this.http.postWithParams(
      ...
      this.generatePDF(columnsList, this.ovlastenaOsobaMjTr, columnsList.length, this.t.translate('OvlasteneOsobeMjTr'));
    });
