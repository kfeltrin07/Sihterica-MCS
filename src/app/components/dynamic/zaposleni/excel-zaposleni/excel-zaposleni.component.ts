...
export class ExcelZaposleniComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ExcelZaposleniComponent>,
  ...
  public getData(): void {
    ...
    this.http.postWithParams(
      ...
      this.generateExcel(columnsList, this.zaposleni, columnsList.length, this.t.translate('Zaposleni'));
    });
