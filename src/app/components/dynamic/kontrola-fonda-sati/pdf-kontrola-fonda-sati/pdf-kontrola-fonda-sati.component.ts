...
export class PdfKontrolaFondaSatiComponent {
  ...
  public generatePDF(columns: string[], data: any, numberOfColumns: number, title: string): void {
    ...
    this.globalVar.headerTitle = this.t.translate('KontrolaFondaSati');
  ...
  public getData(): void {
    ...
    this.http.postWithParams(
      ...
      this.generatePDF(columnsList, this.fondSati, columnsList.length, this.t.translate('KontrolaFondaSati'));
    });
