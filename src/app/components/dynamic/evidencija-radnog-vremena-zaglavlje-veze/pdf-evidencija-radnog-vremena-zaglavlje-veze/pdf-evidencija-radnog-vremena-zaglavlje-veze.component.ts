...
export class PdfEvidencijaRadnogVremenaZaglavljeVezeComponent {
  ...
  public generatePDF(columns: string[], data: any, numberOfColumns: number, title: string): void {
    ...
    this.globalVar.headerTitle = this.t.translate('EvidencijaRadVremZagVeze');
  ...
  public getData(): void {
    ...
    this.http.postWithParams(
      ...
      this.generatePDF(columnsList, this.evidencijaRadVreZagVeze, columnsList.length, this.t.translate('EvidencijaRadVremZagVeze'));
    });
