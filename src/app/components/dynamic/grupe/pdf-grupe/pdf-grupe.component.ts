...
export class PdfGrupeComponent {
  ...
  public generatePDF(columns: string[], data: any, numberOfColumns: number, title: string): void {
    ...
    this.globalVar.headerTitle = this.t.translate('Grupe');
  ...
  public getData(selectedSearchOption: string): void {
    ...
    this.http.postWithParams(
      ...
      this.generatePDF(columnsList, this.grupe, columnsList.length, this.t.translate('Grupe'));
    });
