...
export class PdfPregledOperateraComponent {
  ...
  public generatePDF(columns: string[], data: any, numberOfColumns: number, title: string): void {
    ...
    this.globalVar.headerTitle = this.t.translate('OvlasteneOsobe');
  ...
  public getData(selectedSearchOption: string): void {
    ...
    this.http.postWithParams(
      ...
      this.generatePDF(columnsList, this.operateri, columnsList.length, this.t.translate('OvlasteneOsobe'));
    });
