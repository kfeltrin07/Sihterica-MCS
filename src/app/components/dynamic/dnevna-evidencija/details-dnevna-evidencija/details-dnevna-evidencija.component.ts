...
export class DetailsDnevnaEvidencijaComponent implements OnInit{
  ...
  public filterColumn(key:string){
    let excluded=['RN','UKUPANBROJSLOGOVA','IDKORISNIKA','VATBROJVLASNIKA','SIFVLAS','SIF_MTX','SIF_VPX','IDOHH','IODHH','MBRX','OSOBAX','ODHH','DOHH','ISATI']; // OVE VRIJEDNOSTI NEBUDU BILE PRIKAZANE 
