...
@Component({
    selector: 'app-excel-evidencija-radnog-vremena-zaglavlje',
    imports: [
        MatDialogModule,
        MatRadioModule,
        MatButtonModule,
    ...
    templateUrl: './excel-evidencija-radnog-vremena-zaglavlje.component.html',
    styleUrl: './excel-evidencija-radnog-vremena-zaglavlje.component.scss'
})
export class ExcelEvidencijaRadnogVremenaZaglavljeComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ExcelEvidencijaRadnogVremenaZaglavljeComponent>,
  ...
  public getData(): void {
    ...
    this.http.postWithParams(
      ...
      this.generateExcel(columnsList, this.evidencijaRadVreZag, columnsList.length, this.t.translate('EvidencijaRadnogVremenaZaglavlje'));
    });
