...
export class PickEvidencijaHelpOjComponent implements OnInit {
  ...
  public evidencijaRadVreOj: EvidencijaRadVreOj[] = [];
  public EvidencijaRadVreOj: EvidencijaRadVreOj = {
    UKUPANBROJSLOGOVA: 0,
    RN: 0,
    SIF_OJ: "",
  ...
  public dataSource = this.evidencijaRadVreOj;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PickEvidencijaHelpOjComponent>
  ) { }

  public ngOnInit(): void {
    this.getEvRadnogVremenaSviRadniciHelpOj();
  }

  public getEvRadnogVremenaSviRadniciHelpOj(): void {
    this.http.post(
      ...
      this.evidencijaRadVreOj = response.debugData.data;
      this.dataSource = this.evidencijaRadVreOj;
  ...
  public setVisibleColumnsFromEvent(): void {
    ...
    for (let i = 0; i < this.globalVar.EvidencijaRadVreOjDisplayedColumns.length; i++) {
      this.displayedColumns.push(this.globalVar.EvidencijaRadVreOjDisplayedColumns[i].name);
    }
  }

  public pickEvidencijaRadVreOj(row: EvidencijaRadVreOj): void {
